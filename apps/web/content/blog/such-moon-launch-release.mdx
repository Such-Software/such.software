...
It sat there, mostly forgotten, for a long time. Every once in a while I'd open the project and think *there's something here.* The core loop of gravity, fuel, and an unforgiving landing is one of the all-time classics, going back to the 1969 [Lunar Lander mainframe game](https://en.wikipedia.org/wiki/Lunar_Lander_(video_game_genre)). Done right, it never gets old.
