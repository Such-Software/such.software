...
const products: Product[] = [
  ...
  },
  {
    slug: "bloomword",
    title: "Bloomword",
    description: "A daily word game where everyone gets the same letters and races the sunset; every word you find grows a biome-specific, living 3D typographic tree. Build streaks, collect biomes, and share your bloom. Free on iOS and Android; learn more at bloomword.earth.",
    color: "green",
