...
export const PortfolioGrid = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-4 auto-rows-[300px] gap-4 max-w-7xl mx-auto p-4 z-10 relative">
      ...
      <Card className="md:col-span-2 md:row-span-2 relative group overflow-hidden border-0 bg-slate-900">
      ...
      <Card className="md:col-span-2 relative group overflow-hidden bg-zinc-100">
      ...
      <Card className="md:col-span-1 relative group overflow-hidden bg-orange-50/90 dark:bg-orange-950/90 border-orange-500/20">
        <div className="p-6">
      ...
      <Card className="md:col-span-1 relative group bg-indigo-50/90 dark:bg-indigo-950/90 border-indigo-500/20">
         <div className="p-6">
